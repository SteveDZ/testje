...
{
  "projectName" : "testje",
  "repositoryPrefix" : "eu.gcr.io/sdezitter-labs/"
}
```
## Log
```
...
┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [tanzu-java-web-app->testje]
┃ ┃ ┃ ┃ ┃ ┏ engine.transformations[0].merge.transformations[0].sources[1].<combo>.transformations[1].transformations[1] (ReplaceText)
┃ ┃ ┃ ┗ ┗ ┗  Info Will replace [your-registry.io/project->eu.gcr.io/sdezitter-...(truncated)]
